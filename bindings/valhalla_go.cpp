...
const char * actor_route(Actor actor, const char * req) {
...
const char * actor_locate(Actor actor, const char * req) {
...
const char * actor_optimized_route(Actor actor, const char * req) {
...
const char * actor_matrix(Actor actor, const char * req) {
...
const char * actor_isochrone(Actor actor, const char * req) {
...
const char * actor_trace_route(Actor actor, const char * req) {
...
const char * actor_trace_attributes(Actor actor, const char * req) {
...
const char * actor_height(Actor actor, const char * req) {
...
const char * actor_transit_available(Actor actor, const char * req) {
...
const char * actor_expansion(Actor actor, const char * req) {
...
const char * actor_centroid(Actor actor, const char * req) {
...
const char * actor_status(Actor actor, const char * req) {
